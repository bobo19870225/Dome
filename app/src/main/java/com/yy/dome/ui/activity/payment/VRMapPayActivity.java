...
public class VRMapPayActivity extends BasenActivity<IView, MultiFunctionPresenter> implements IView {
    ACache aCache;
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.fanhui_lay:
                ...
                break;
            case R.id.shoppay:
               // p.functionMultiRequests(Api.URLs + "student.htm?", VRMapPayActivity.this, Api.VRMapPay(UtilFileDB.Tel(),""), 1);
                break;
        }
    }
}
