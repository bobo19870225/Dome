...
public class PolicyActivity extends BasenActivity<IView, MultiFunctionPresenter> implements IView {
    ACache aCache;
    Intent intent;
    Context context;
    ...
    private String url = IUtilDBRequest.URL + "&method=getOneScorePage&page=1&wlk=1" + "&phone=" + UtilFileDB.Tel() + "&token=" + UtilFileDB.Token();
