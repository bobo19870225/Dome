...
public class RecycAdapter extends RecyclerView.Adapter<RecycAdapter.ViewHolder> {
    ...
    public RecycAdapter(Context context,List<VideoInfo> lists) {
        this.lists = lists;
        con=context;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View viewHolder = layoutInflater.inflate(R.layout.item_video_view, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            iv_nul = view.findViewById(R.id.video_image);
