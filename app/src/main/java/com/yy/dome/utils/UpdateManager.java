...
public class UpdateManager {
    ...
    private String apkUrl = "http://helloyun.cn:8080/apk/aizy.apk"; //apk下载地址
...
//    private double clientVersion = 1.0; //客户端当前的版本号
    ...
    /** 显示更新对话框 */
    public void showNoticeDialog(double serverVersion,double clientVersion ,boolean forceUpdate) {
        //如果版本最新，则不需要更新
        Log.e("对比",String.valueOf(serverVersion)+"==="+String.valueOf(clientVersion));
