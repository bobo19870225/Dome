...
public class FormBatchActivityThree extends BasenActivity<IView, MultiFunctionPresenter> implements IView {
    ACache aCache;
    ...
    protected void initView() {
        ...
        showMyDialog();
        try {
            p.functionMultiRequests(Api.URLs + "ideal.htm?", context, Api.LookUpFORMThree(UtilFileDB.Tel(), UtilTools.MD5(UtilFileDB.Token() + UtilFileDB.Tel() + 123)), 1);
        } catch (Exception e) {
        }
    }
